...
av_export int av_packet_merge_side_data(AVPacket *pkt);

av_export int av_packet_split_side_data(AVPacket *pkt);
 ...
 */
av_export const char *avcodec_get_name(enum CodecID id);
 ...
 */
av_export int avcodec_open2(AVCodecContext *avctx, AVCodec *codec, AVDictionary **options);
 ...
 */
av_export void av_log_ask_for_sample(void *avc, const char *msg, ...) av_printf_format(2, 3);
