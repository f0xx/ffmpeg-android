...
av_export void ff_mpadsp_init(MPADSPContext *s);

extern int32_t ff_mpa_synth_window_fixed[] av_export ;
extern float   ff_mpa_synth_window_float[] av_export ;

av_export void ff_mpa_synth_filter_fixed(MPADSPContext *s,
                               int32_t *synth_buf_ptr, int *synth_buf_offset,
                               int32_t *window, int *dither_state,
                               int16_t *samples, int incr,
                               int32_t *sb_samples);

av_export void ff_mpa_synth_filter_float(MPADSPContext *s,
...
av_export void ff_mpa_synth_init_float(float *window);
av_export void ff_mpa_synth_init_fixed(int32_t *window);

av_export void ff_mpadsp_apply_window_float(float *synth_buf, float *window,
                                  int *dither_state, float *samples,
                                  int incr);
av_export void ff_mpadsp_apply_window_fixed(int32_t *synth_buf, int32_t *window,
