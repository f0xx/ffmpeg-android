...
extern const int avpriv_mpeg4audio_sample_rates[16] av_export ;
 ...
 */
av_export int avpriv_mpeg4audio_get_config(MPEG4AudioConfig *c, const uint8_t *buf, int buf_size);
